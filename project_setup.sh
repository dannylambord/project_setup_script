...
sudo cp /home/hughfharding/frontend.service /etc/systemd/system/frontend.service
sudo cp /home/hughfharding/backend.service /etc/systemd/system/backend.service
